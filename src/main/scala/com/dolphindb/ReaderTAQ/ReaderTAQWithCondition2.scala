...
//    val frame = spark.sql("select * from TAQ where SYMBOL ='IBM' and date = to_date('2007-08-10') and TIME >= to_timestamp('2019-04-12 09:30:00')")
    //    b-2
        val frame =  spark.sql("select SYMBOL, TIME, BID ,OFR from TAQ where SYMBOL in ('IBM', 'MSFT', 'GOOG', 'YHOO') and" +
                    " date=to_date('2007-08-01') and TIME between to_timestamp('2019-04-12 09:30:00') and" +
                    " to_timestamp('2019-04-12 10:30:59') and BID > 0 and OFR > BID")
