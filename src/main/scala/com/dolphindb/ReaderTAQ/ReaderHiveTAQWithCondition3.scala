...
object ReaderHiveTAQWithCondition3 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val spark = SparkSession.builder().appName("ReaderHiveTAQWithCondition3")
      .enableHiveSupport()
...
//                  " to_date('2007-08-10') and TIME between to_timestamp('2007-08-10 09:30:00') and to_timestamp('2007-08-10 09:30:59') and BID > 0 and OFR > BID")
    ...
    //    b-3
        val frame = spark.sql("select * from TAQ where date = to_date('2007-08-27') and SYMBOL = 'EBAY' order by (OFR-BID) desc ")
    //    b-4
