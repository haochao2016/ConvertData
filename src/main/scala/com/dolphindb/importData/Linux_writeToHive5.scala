...
object Linux_writeToHive5 {
  def main(args: Array[String]): Unit = {

    val startTime = System.currentTimeMillis()
    val spark = SparkSession.builder().appName("Linux_writeToHive5")
//      .master("local[7]")
      .enableHiveSupport()
      .getOrCreate()
    ...
    val writer = new PrintWriter(new File("/home/chao/apps/spark/writerH5.txt"))
