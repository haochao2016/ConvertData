...
object Linux_writeToParquet2 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val hdds = Array("0823","0824","0827", "0828")

    for (hdd <- hdds) {
      val dataDF = spark.read
        .option("header", "true")
        .csv(s"file:///hdd/hdd4/Spark-DolphinDB-TAQ/TAQ2007${hdd}.csv")
    ...
    val writer = new PrintWriter(new File("/home/chao/apps/spark/writer2.txt"))
