...
object Linux_writeToHive2 {

  def main(args: Array[String]): Unit = {

    val startTime = System.currentTimeMillis()
    val spark = SparkSession.builder().appName("Linux_writeToHive2")
//      .master("local[7]")
      .enableHiveSupport()
      .getOrCreate()
    ...
    val writer = new PrintWriter(new File("/home/chao/apps/spark/writerH2.txt"))
